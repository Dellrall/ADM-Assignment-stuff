...
├── ExtraModule.md                            # Group Selection (Refund & Return Management)
└── modules/
    ...
    │   └── README.md                         # Presentation & Verification Guide
    │
    └── 05_refund_return/                     # Member 5: Refund & Return Management (Selected Extra Module)
        ├── 01_queries.sql                    # Task 4 & 8: Supplier Liability & Branch Return Rates
        ├── 02_procedures.sql                 # Task 5 & 8: Submit Claim (7-Day Rule) & Adjudication
        ├── 03_triggers.sql                   # Task 6: Rule 33 Defect Guard & Amount Ceiling Guard
        ├── 04_reports.sql                    # Task 7: Refund Claim Dossier & Spoilage Quality Audit
        └── README.md                         # Presentation & Verification Guide
```
...
| **Member 5** | **Refund & Return (Extra)** | • Supplier Defect Liability<br>• Branch Claim Risk Audit | • 7-Day Refund Submission<br>• Manager Claim Adjudication | • Rule 33 Defect Guard<br>• Refund Amount Ceiling | • Refund Ticket Dossier<br>• Branch Spoilage Audit |
