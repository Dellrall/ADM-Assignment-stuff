...
| **Task 7** | [`04_reports.sql`](04_reports.sql) | • **Report 1:** `sp_rpt_branch_inventory_audit` (Nested cursors: Branch $\rightarrow$ Live Inventory $\rightarrow$ Recent Stock Logs).<br>• **Report 2:** `sp_rpt_supplier_proc_dossier` (3-Tier Nested cursors: Supplier $\rightarrow$ POs $\rightarrow$ Itemized Line Costs). |
